...
class UserEngagementSectionMobile extends Component{
  constructor(props){
    super(props);
  ...
  render(){
    ...
    return(
      <Link to={`${configuration.APP_ROOT_URL}/posts/new`}>
        <div className="o-user-engagement-section o-user-engagement-section-mobile">
          <button type="submit" className="o-close-button" onClick={this.handleClick}>
            x
          </button>
          <p className="o-user-engagement-title">Ask your first question about...</p>
...
UserEngagementSectionMobile.propTypes = {
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(UserEngagementSectionMobile));