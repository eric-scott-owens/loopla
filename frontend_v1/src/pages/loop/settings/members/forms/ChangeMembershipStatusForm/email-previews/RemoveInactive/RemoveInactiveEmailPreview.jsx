...
const RemoveInactiveEmailPreview = ({children, loop, invitee}) => (
  <EmailPreview
    subject={`Your status in the ${loop.name} loop has changed.`}
    className="o-remove-inactive-email-preview"
  >
    <React.Fragment>
...
RemoveInactiveEmailPreview.propTypes = {
...
export default connect(MapStateToProps)(RemoveInactiveEmailPreview);