...
const RemoveMemberEmailPreview = ({children, loop, invitee}) => (
  <EmailPreview
    subject={`Your status in the ${loop.name} loop has changed.`}
    className="o-remove-member-email-preview"
  >
    <React.Fragment>
...
RemoveMemberEmailPreview.propTypes = {
...
export default connect(MapStateToProps)(RemoveMemberEmailPreview);